  ...
  <div class="app">
    ...
    <div class="lists">
      <div
        ...
        @dragover.prevent
        @drop="drop('todo')"
        :class="{ highlight: isHighlighted('todo') }"
      >
        ...
        <div
          class="list-item"
          v-for="item in filteredTasks('todo')"
          :key="item.id"
          draggable="true"
          @dragstart="dragStart(item)"
        >
          <!-- Update here to navigate to task details -->
          <router-link :to="'/tasks/' + item.id" class="linkItem">{{
            item.content
          }}</router-link>
        </div>
        <input
          class="list-item"
          v-if="showNewTodoInput"
          type="text"
          v-model="newTodoItem"
      ...
      >
        ...
        <div
          class="list-item"
          v-for="item in filteredTasks('pending')"
          :key="item.id"
          draggable="true"
          @dragstart="dragStart(item)"
        >
        ...
        <input
          v-if="showNewPendingInput"
          type="text"
          v-model="newPendingItem"
          placeholder="Add new item"
        />
      ...
      <div
        ...
        @dragover.prevent
        @drop="drop('done')"
        :class="{ highlight: isHighlighted('done') }"
      >
        <div class="topHeading">
          <div class="heading">
        ...
        <div
          class="list-item"
          v-for="item in filteredTasks('done')"
          :key="item.id"
          draggable="true"
          @dragstart="dragStart(item)"
        >
  ...
  methods: {
    ...
    isHighlighted(list) {
      return (
        ...
        this.filteredTasks(list).length > 0
      );
    },
    saveTasks() {
